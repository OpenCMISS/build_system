...
if(OC_CMAKE_STAGE STREQUAL "configure")
  ...
  if(OC_HAVE_MULTICONFIG_ENV)
    ...
    set(OC_MPI_INSTALL_BASE_DIR "${OC_INSTALL_ROOT}/${OC_MPI_ARCH_PATH}/${CMAKE_BUILD_TYPE}")
    set(OC_NOMPI_INSTALL_BASE_DIR "${OC_INSTALL_ROOT}/${OC_NOMPI_ARCH_PATH}/${CMAKE_BUILD_TYPE}")
    set(OC_DEPENDENCIES_MPI_INSTALL_BASE_DIR "${OC_DEPENDENCIES_INSTALL_ROOT}/${OC_MPI_ARCH_PATH}/${CMAKE_BUILD_TYPE}")
    set(OC_DEPENDENCIES_NOMPI_INSTALL_BASE_DIR "${OC_DEPENDENCIES_INSTALL_ROOT}/${OC_NOMPI_ARCH_PATH}/${CMAKE_BUILD_TYPE}")
  endif()
  OCCMakeDebug("" 1)
  ...
  if(OC_HAVE_MULTICONFIG_ENV)
    ...
    if(OpenCMISS_WITH_MPI)
      list(APPEND OC_EXTERNAL_CMAKE_ARGS "-DCMAKE_PREFIX_PATH=${OC_DEPENDENCIES_MPI_INSTALL_BASE_DIR}${OC_CMAKE_SEPARATOR}${OC_DEPENDENCIES_NOMPI_INSTALL_BASE_DIR}${OC_CMAKE_SEPARATOR}${CMAKE_BUILD_TYPE}")
      set(CMAKE_PREFIX_PATH ${OC_DEPENDENCIES_MPI_INSTALL_BASE_DIR} ${OC_DEPENDENCIES_NOMPI_INSTALL_BASE_DIR}${OC_CMAKE_SEPARATOR}${CMAKE_BUILD_TYPE})
    else()
      list(APPEND OC_EXTERNAL_CMAKE_ARGS "-DCMAKE_PREFIX_PATH=${OC_DEPENDENCIES_NOMPI_INSTALL_BASE_DIR}${OC_CMAKE_SEPARATOR}${CMAKE_BUILD_TYPE}")
      set(CMAKE_PREFIX_PATH "${OC_DEPENDENCIES_NOMPI_INSTALL_BASE_DIR}${OC_CMAKE_SEPARATOR}${CMAKE_BUILD_TYPE}")
    endif()
  endif()
  ...
  message(STATUS "OC_MPI_INSTALL_BASE_DIR = '${OC_MPI_INSTALL_BASE_DIR}'.")
  message(STATUS "OC_NOMPI_INSTALL_BASE_DIR = '${OC_NOMPI_INSTALL_BASE_DIR}'.")
  ...
  if(OpenCMISS_USE_ZLIB)
    ...
    if(NOT ZLIB_FOUND)
      ...
      set(OC_ZLIB_DEFINES "-DZLIB_BUILD_SHARED=${OpenCMISS_DEPENDENCIES_SHARED_LIBRARIES}")
      set(OC_ZLIB_DEFINES "-DZLIB_BUILD_STATIC=${OpenCMISS_DEPENDENCIES_STATIC_LIBRARIES}")
      set(OC_ZLIB_DEFINES "-DZLIB_BUILD_TESTING=${OpenCMISS_WITH_DEPENDENCIES_TESTS}")
      OCAddExternal(
	"${OC_ZLIB_NAME}"
	"${OC_ZLIB_REPO_NAME}"
  ...
  if(OpenCMISS_USE_libCellML)
    ...
    if(NOT libCellML_FOUND)
      ...
      if(OC_BUILD_TYPE_RELEASE)
	list(APPEND OC_libCellML_DEFINES "-DLIBCELLML_MEMCHECK=OFF")     
      endif()
      OCAddExternal(
	"${OC_libCellML_NAME}"
  ...
  if(OpenCMISS_USE_SCOTCH)
    ...
    if(NOT SCOTCH_FOUND)
      ...
      list(APPEND OC_SCOTCH_DEFINES "-DLIBSCOTCHERR=libscotcherr")
      list(APPEND OC_SCOTCH_DEFINES "-DLIBPTSCOTCHERR=libptscotcherr")
      list(APPEND OC_SCOTCH_DEFINES "-DENABLE_TESTS=${OpenCMISS_WITH_DEPENDENCIES_TESTS}")
      OCAddExternal(
	"${OC_SCOTCH_NAME}"
	"${OC_SCOTCH_REPO_NAME}"
	"${OC_DEPENDENCIES_SOURCE_BASE_DIR}"
  ...
  if(OpenCMISS_USE_SUNDIALS)
	...
	#add_library(SUNDIALS ALIAS SUNDIALS::SUNDIALS)
      endif()      
    endif()
  endif()
  ...
  set(OC_OpenCMISS_REPO_NAME "libOpenCMISS")
