...
function(OCSetToolchain ROOT_DIRECTORY)
  ...
  if(_LOWERCASE_TOOLCHAIN STREQUAL "gnu")
    ...
    set(CMAKE_TOOLCHAIN_FILE "${ROOT_DIRECTORY}/Toolchains/OCGNUToolchain.cmake" FORCE)
  ...
  elseif(_LOWERCASE_TOOLCHAIN STREQUAL "intel")
    ...
    set(CMAKE_TOOLCHAIN_FILE "${ROOT_DIRECTORY}/Toolchains/OCIntelToolchain.cmake" FORCE)
    include(${CMAKE_TOOLCHAIN_FILE})
  elseif(_LOWERCASE_TOOLCHAIN STREQUAL "oldintel")
    ...
    set(CMAKE_TOOLCHAIN_FILE "${ROOT_DIRECTORY}/Toolchains/OCOldIntelToolchain.cmake" FORCE)
    include(${CMAKE_TOOLCHAIN_FILE})
  elseif(_LOWERCASE_TOOLCHAIN STREQUAL "llvm")
    ...
    set(CMAKE_TOOLCHAIN_FILE "${ROOT_DIRECTORY}/Toolchains/OCLLVMToolchain.cmake" FORCE)
    include(${CMAKE_TOOLCHAIN_FILE})
  ...
  elseif(_LOWERCASE_TOOLCHAIN STREQUAL "msvc")
    ...
    set(CMAKE_TOOLCHAIN_FILE "${ROOT_DIRECTORY}/Toolchains/OCMSVCToolchain.cmake" FORCE)
    include(${CMAKE_TOOLCHAIN_FILE})
  ...
  # Force the compilers to be set.
  if(DEFINED OC_CMAKE_C_COMPILER)
    set(CMAKE_C_COMPILER "${OC_CMAKE_C_COMPILER}" CACHE STRING "C Compiler" FORCE)
  endif()
  if(DEFINED OC_CMAKE_CXX_COMPILER)
    set(CMAKE_CXX_COMPILER "${OC_CMAKE_CXX_COMPILER}" CACHE STRING "C++ Compiler" FORCE)
  endif()
  if(DEFINED OC_CMAKE_Fortran_COMPILER)
    set(CMAKE_Fortran_COMPILER "${OC_CMAKE_Fortran_COMPILER}" CACHE STRING "Fortran Compiler" FORCE)
  endif()

  OCCMakeDebug("Using a toolchain of ${OC_TOOLCHAIN}." 1)
  OCCMakeDebug("  CMAKE_C_COMPILER = '${CMAKE_C_COMPILER}'." 2)
  OCCMakeDebug("  CMAKE_CXX_COMPILER = '${CMAKE_CXX_COMPILER}'." 2)
  OCCMakeDebug("  CMAKE_Fortran_COMPILER = '${CMAKE_Fortran_COMPILER}'." 2)
  
  unset(_LOWERCASE_TOOLCHAIN)
  unset(OC_CMAKE_C_COMPILER)
  unset(OC_CMAKE_CXX_COMPILER)
  unset(OC_CMAKE_Fortran_COMPILER)
